classdef DLMDM_Simulated_realistic
    ...
    methods
        function obj = DLMDM_Simulated_realistic(Subject, Category, currentParition, currentCategory, runCase, varargin)
            [obj.Num_Trial, obj.m_all, obj.d,obj.L, obj.par] = process_options(varargin,...
                'Num_Trial',32,'m_all',10:200,'d',3,'L',2000,'par',0);
            warning off;
            %% Load Data
            iF1 = strcat('Synthetic_Input\PopulationNeurons&5Categories\NestCVDLMDM_synthetic_Realistic_', runCase,'_Category', currentCategory, mat2str(currentParition),'.mat');
            load(iF1);
...
%             obj.CrossValSet = CrossValSet;
            ...
            obj.oF = strcat('Results\PopulationNeurons&5Categories\NestedCVDLMDM_synthetic_Realistic&', '_', runCase,'_Category',currentCategory,'_part',mat2str(currentParition),'_rep.mat');
            MDfit = obj;
            save(obj.oF,'MDfit')
        end
