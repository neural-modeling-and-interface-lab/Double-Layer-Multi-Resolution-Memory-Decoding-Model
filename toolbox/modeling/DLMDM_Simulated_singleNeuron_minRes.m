classdef DLMDM_Simulated_singleNeuron_minRes
    ...
    methods
        function obj = DLMDM_Simulated_singleNeuron_minRes(Subject, Category, currentParition, nCategories, runCase, varargin)
            [obj.Num_Trial, obj.m_all, obj.d,obj.L, obj.par] = process_options(varargin,...
                'Num_Trial',32,'m_all',10:200,'d',3,'L',2000,'par',0);
            warning off;
            %% Load Data
            iF1 = strcat('Synthetic_Input\SingleNeuron&', mat2str(nCategories), 'Categories','\NestCVDLMDM_synthetic_SingleNeuron&', mat2str(nCategories),'Categories_',Category,'_fold_', mat2str(currentParition),'_', runCase,'.mat');
            load(iF1);
            ...
            obj.oF = strcat('Results\SingleNeuron&', mat2str(nCategories), 'Categories','\Raw Results\NestedCVDLMDM_synthetic_SingleNeuron&', mat2str(nCategories),'Categories_',Category,'_part',mat2str(currentParition), '_', runCase,'_minRes.mat');
            MDfit = obj;
            save(obj.oF,'MDfit')
        end
