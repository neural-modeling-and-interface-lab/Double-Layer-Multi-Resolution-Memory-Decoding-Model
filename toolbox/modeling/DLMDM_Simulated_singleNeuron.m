classdef DLMDM_Simulated_singleNeuron
    ...
    methods
        function obj = DLMDM_Simulated_singleNeuron(Subject, Category, currentParition, nCategories, runCase, varargin)
            ...
            obj.oF = strcat('Results\SingleNeuron&', mat2str(nCategories), 'Categories','\Raw Results\NestedCVDLMDM_synthetic_SingleNeuron&', mat2str(nCategories),'Categories_',Category,'_part',mat2str(currentParition), '_', runCase,'_rep.mat');
            MDfit = obj;
            save(obj.oF,'MDfit')
        end
