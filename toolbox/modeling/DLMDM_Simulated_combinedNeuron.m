classdef DLMDM_Simulated_combinedNeuron
    ...
    methods
        function obj = DLMDM_Simulated_combinedNeuron(Subject, Category, currentParition, nCategories, runCase, varargin)
            ...
            obj.oF = strcat('Results\CombinedNeuron&', mat2str(nCategories), 'Categories','\Raw Results\NestedCVDLMDM_synthetic_CombinedNeuron&', mat2str(nCategories),'Categories_',Category,'_part',mat2str(currentParition), '_', runCase,'_rep.mat');
            MDfit = obj;
            save(obj.oF,'MDfit')
        end
